...
export function BingoCell({ word, isMarked, onClick, disabled, isFreeSpace, isCurrentWord }: BingoCellProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        'group w-full aspect-square rounded-lg flex flex-col items-center justify-center p-2 sm:p-2.5 text-center outline-none relative transition-all duration-200',

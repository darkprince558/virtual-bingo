      ...
      <nav className="relative z-10 h-16 px-6 sm:px-10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="hidden sm:inline">{t('home.host_login', 'Host a Game')}</span>
          </Link>
        </div>
      </nav>
        ...
        <div className="w-full max-w-lg">
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3.5 rounded-xl text-sm font-bold mb-3 transition-all hover:brightness-95 active:scale-[0.99] hover:shadow-sm"
              style={{ background: '#FFFFFF', color: '#1C1917', border: '1.5px solid #E7E5E4' }}
            >
              <div className="flex items-center gap-3">
                ...
                {t('home.entra_login', 'Sign in with Microsoft Entra')}
              </div>
              <ArrowRight className="w-4 h-4 text-gray-400" />
            </button>
            <div className="text-center mb-6">
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wide">
                {t('home.entra_disclaimer', 'For CGI partners only — account will be verified')}
              </span>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 text-[11px] uppercase font-extrabold tracking-widest" style={{ background: '#FFFFFF', color: '#D6D3D1' }}>
                  {t('home.join_with_code', 'Join with a Code')}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <input
                  id="playerName"
                  type="text"
                  placeholder={t('home.name_placeholder', 'Your Name')}
                  value={playerName}
              ...
              >
                <input
                  id="gameCode"
                  type="text"
                  placeholder={t('home.game_code', 'GAME CODE')}
                  value={gameCode}
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                {t('home.host_link', 'I\'m a host, take me to the dashboard')}
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                {t('home.admin_link', 'Admin Operations Center')}
              </div>
          ...
          <motion.p
            ...
            style={{ color: '#D6D3D1' }}
          >
            {t('home.footer', 'Internal corporate tool · Authentication coming soon')}
          </motion.p>
        </div>
      </main>
    </div>
